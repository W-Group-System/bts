...
<div class="modal" id="edit-task{{ $c->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('/corrective/update/'.$c->id) }}">
                @csrf
                <div class="modal-body px-4">
                    <div class="row gy-2">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="tel" name="viber_number" class="form-control @if($errors->has('viber_number')) is-invalid @endif" id="viberNumber" value="{{ old('viber_number', $c->viber_number) }}">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="text" name="title" class="form-control @if($errors->has('title')) is-invalid @endif" id="task-name" value="{{ old('title', $c->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="date" name="due_date" class="form-control @if($errors->has('due_date')) is-invalid @endif" value="{{ old('due_date', $c->due_date) }}">
                        ...
                        <div class="col-xl-6">
                            ...
                            <select class="form-control" data-trigger name="building">
                                @foreach ($buildings as $building)
                                    <option value="{{ $building->id }}" @if(old('building', $c->due_date) == $building->id) selected @endif>{{ $building->code }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-xl-6">
                            ...
                            <select class="form-control @if($errors->has('due_date')) is-invalid @endif" data-trigger name="priority" id="choices-single-default1">
                                <option value="High" @if(old('priority', $c->priority) == "High") selected @endif>High</option>
                                <option value="Medium" @if(old('priority', $c->priority) == "Medium") selected @endif>Medium</option>
                                <option value="Low" @if(old('priority', $c->priority) == "Low") selected @endif>Low</option>
                            </select>
                        </div>
                        {{-- <div class="col-xl-12">
                        ...
                        <div class="col-xl-12">
                            ...
                            <textarea name="task" class="form-control summernote @if($errors->has('task')) is-invalid @endif" cols="30" rows="10">{{ old('task', $c->task) }}</textarea>
                            @if($errors->has('task'))
